                    ...
                    <Row className="pt-3 pb-5 align-items-center">
                        ...
                        <Col xs={12} md={6} className="my-deets">
                            ...
                            <Row className="d-flex justify-content-end flex-wrap buttons" >
                                <div>
                                <a href="#contact">
                                    <button><a href='https://1drv.ms/b/s!Aufj6YK-I-1YhIgwGM7uYXJfZIqneQ?e=cvo9oC'>Resume</a></button>
                                    </a>
                                </div>
                                <div>
                                    <a href="#contact">
                                    <button><a href='https://www.youtube.com/watch?v=K8ma6T560Tc'>Video Resume</a></button>
                                    </a>
                                </div>
                            </Row> 
                        </Col>
